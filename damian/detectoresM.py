...
ted=(1+tea)**0.0027-1
cuotak=(saldo_capital+suma_factores)

#Detector
#Si la cuota mensual del cliente es <71.70 entonces tiene menor tiempo para pagar
tiempo_pagar=(cuotak<71.70)
...
print("# cuotak:",cuotak," #")
print("# tiempo_pagar: ",tiempo_pagar," #")
print("####################################")
...
#Detector
#si el producto bruto interno es>1250 entonces se dice que la empresa se encuentra en crecimiento
crecimiento=(producto_bruto_interno>1250)
...
#Detector
#si su importe de interes generado>4200 entonces existe rentabilida
rentabilidad=(importe_interes_generado>4200)
...
#Dectector
#El mantnimiento de valor cuenta de ahorro aumentara si esta es>4.61
aumento=(mantenimiento_valor_cuenta_de_ahorro>4.61)
...
#Detector
#si el costo de produccion de la empresa es<1234 entonces tendra perdida
perdida=(costo_produccion<1234)
