...
#Detector
#sea la suma total de ventas netas >15000 entonces los impuestos son mas altos
impuestos=(total_venetas>15000)
...
#Detector
#Sea la suma total del Costo de ventas <2000 entonces las utilidades serian mayores
utilidades_costo=(total_costoven<2000)
...
print("# Utilidades_Costo: ",utilidades_costo," #")
print("#######################################")
...
#Detector
#si el total de especies en riesgo es <300 entonces no hay peligro
peligro=(sumatotal<300)
...
#Detector
#Si el procentajes total del margen de flujo es < 100 entonces tiene menor capacidad para generar sus beneficios
beneficios=(porcentajetotal1<100)
...
#Detector
#Si los resultados totales son > 3000 entonces sus ingresos son menores
ingresos_operaciones=(total_resul>300)
...
print("# Ingreso total: ",ingresos_operaciones," #")
print("#######################################")
...
#Detector
#Si el total de participaciones no controladas es < 150.67 tiene menor actividad la empresa
actividad=(total_partno<150.67)
...
#Detector
#Si la suma total de dividendos por CPO es < 1.45 entonces la rentabilidad es baja
rentabilidad=(suma_dividendosCPO<1.45)
